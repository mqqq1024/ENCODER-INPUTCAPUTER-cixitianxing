...
/* task stack size */
#define CS5460A_STACK_SIZE  512
//#define SPEED_STACK_SIZE  512
#define GET_VOL_STACK_SIZE  512
#define UART_COM_STACK_SIZE 512 
#define TEST_STACK_SIZE 256

/* task priority */
#define CS5460A_TEST_PRIORITY  (tskIDLE_PRIORITY+4)
//#define SPEED_TEST_PRIORITY (tskIDLE_PRIORITY+3)
#define GET_VOL_TEST_PRIORITY (tskIDLE_PRIORITY+3)
#define UART_COM_PRIORITY  (tskIDLE_PRIORITY+2)
